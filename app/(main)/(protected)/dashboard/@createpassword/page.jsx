...
const CreatePassword = () => {
  ...
  const cardAccent = {
    ...
    yellow:
      "text-yellow-500 bg-yellow-50 dark:bg-yellow-500/10 border-yellow-100 dark:border-yellow-500/20",
    purple:
    ...
    slate:
      "text-slate-500  bg-slate-50  dark:bg-slate-500/10  border-slate-100  dark:border-slate-500/20",
    emerald:
              ...
              {randomCards.length > 0 ? (
                randomCards.map((card, i) => (
                  <ScrollReveal key={i} direction="right" delayMs={i * 100}>
                    ...
                    >
                      <div className={`shrink-0 ${cardAccent[card.color]}`}>
                        {card.icon}
                      </div>
                ...
                <div className="space-y-2.5">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-11 w-full animate-pulse bg-gray-100 dark:bg-gray-800 rounded-xl"
                    />
                  ))}
                </div>
              )}
              ...
              <ScrollReveal direction="right" delayMs={0}>
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
              ...
              <ScrollReveal direction="right" delayMs={100}>
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-200">
                    ...
                    >
                      <div className="overflow-hidden">
                        <div className="px-4 pb-4 space-y-3 border-t border-gray-200 dark:border-gray-700 pt-3">
                          ...
                          {/* Suggestions */}
                          {entryStrength.result?.feedback?.suggestions?.length >
                            0 && (
                            ...
                            <div className="pt-3 border-t border-gray-200 dark:border-gray-700 space-y-2">
                              ...
                              <div className="space-y-1.5">
                                <div className="flex items-center justify-between p-2 rounded-lg bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-700">
                                  ...
                                  <span
                                    className={`text-xs font-black ${entryStrength.score > 70 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}
                                  >
                                    {capitalize(
                                      entryStrength.result.crack_times_display
