...
export const resetVaultConfirmHtml = (name, verifyToken) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <div class="container">
        <div class="header">
            <h1>Vault Reset Request</h1>
            <p>Securely reset your PKey vault.</p>
        </div>

        <div class="content">
            <p>Hello <b>${name || "User"}</b>,</p>
            <p>You recently requested to reset your vault for your PKey account. Click the button below to proceed:</p>

            <div class="button-wrapper">
                <a href="${process.env.NEXT_PUBLIC_BASE_URL}/auth/resetvault/${verifyToken}" class="button">
                    Reset Vault
                </a>
            </div>
            ...
            <p>This link will expire in <strong>10 minutes</strong> for security reasons. If the button above doesn't work, you can also copy and paste the following link into your web browser:</p>
            <p style="font-size: 14px; word-break: break-all; color: #4a5568; overflow-wrap: break-word;">
                <a href="${process.env.NEXT_PUBLIC_BASE_URL}/auth/resetvault/${verifyToken}" style="color: #2b6cb0; text-decoration: underline; font-size: 14px;">${process.env.NEXT_PUBLIC_BASE_URL}/auth/resetvault/${verifyToken}</a>
            </p>

            <p style="margin-top: 25px; color: #718096;">If you did not request a vault reset, please ignore this email or contact our support team immediately.</p>
        </div>
...
export const deleteAccountConfirmHtml = (name, verifyToken) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PKey Account Delete Request</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Securely delete your PKey account.</p>
        </div>

        <div class="content">
            <p>Hello <b>${name || "User"}</b>,</p>
            <p>You recently requested to delete your PKey account. Click the button below to proceed:</p>

            <div class="button-wrapper">
                <a href="${process.env.NEXT_PUBLIC_BASE_URL}/auth/deleteaccount/${verifyToken}" class="button">
                    Delete Account
                </a>
            </div>
            ...
            <p>This link will expire in <strong>10 minutes</strong> for security reasons. If the button above doesn't work, you can also copy and paste the following link into your web browser:</p>
            <p style="font-size: 14px; word-break: break-all; color: #4a5568; overflow-wrap: break-word;">
                <a href="${process.env.NEXT_PUBLIC_BASE_URL}/auth/deleteaccount/${verifyToken}" style="color: #2b6cb0; text-decoration: underline; font-size: 14px;">${process.env.NEXT_PUBLIC_BASE_URL}/auth/deleteaccount/${verifyToken}</a>
            </p>
...
`;
export const accountBlocked = (name, minutes) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <div class="header">
            <h1>Vault Locked Temporarily</h1>
        ...
        <div class="content">
            ...
            <div class="security-alert">
                <p style="margin: 0; color: inherit;">
                    <strong>Security Alert:</strong> Your vault has been <strong>locked temporarily</strong> due to multiple incorrect master password attempts. This is a crucial security measure to protect your sensitive data from unauthorized access.
                </p>
            </div>
            <p>Your vault will <strong>unlock automatically</strong> in about <b>${minutes}</b> minute(s). No action is needed on your part. If you genuinely forgot your master password, you can <strong>reset your vault</strong> instead. Please remember that resetting your vault will <strong>permanently delete</strong> all your saved passwords and data, and this action cannot be undone.</p>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to PKey - Your Secure Vault</title>
  <style>
    body {
      margin: 0;
      padding: 0;
    ...
    /* Blue Info Alert instead of Red Warning */
    .content .alert {
...
<body>
  <div class="container">
    <div class="header">
      <h1>Welcome to PKey! 🚀</h1>
      <p>Your secure, zero-knowledge vault is ready.</p>
    </div>

    <div class="content">
      <p>Hello <b>${name}</b>,</p>
      
      <p>Thank you for joining PKey! You've just taken the best step towards securing your digital identity. Your vault is now active and ready to store your passwords with military-grade encryption.</p>

      <div class="alert">
        <p style="margin: 0; color: inherit;">
          <strong>🔐 Crucial Security Reminder:</strong> PKey operates on a strict zero-knowledge architecture. This means <strong>only you</strong> know your Master Password. We do not store it, and we cannot recover it if lost. Please keep it safe!
        </p>
      </div>

      <p>Whenever you add a password, it gets encrypted locally on your device before it ever reaches our servers. You have complete control over your data.</p>
    ...
    <div class="footer">
      ...
      <p>
        ...
        <a href="${process.env.NEXT_PUBLIC_BASE_URL}/terms&conditions">Terms & Conditions</a>
      </p>
    </div>
  </div>
</body>
...
export const oauthLoginHtml = (name) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PKey - Social Login Notice</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>Password Reset Request</h1>
            <p>Information regarding your PKey account.</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="alert">
                <p style="margin: 0; color: inherit;">
                    <strong>Notice:</strong> We received a password reset request for this email address. However, our records indicate that you registered for PKey using a <strong>Social Provider</strong> (like Google or GitHub).
                </p>
            </div>
            
            <p>Because you use a social provider to log in, you do not have a traditional PKey password to reset. To access your vault, simply return to the login page and sign in using your connected provider.</p>
            ...
            <p style="margin-top: 25px; color: #718096;">If you did not request a password reset, you can safely ignore this email. Your account remains secure.</p>
        </div>
...
export const accountExistsHtml = (name) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PKey - Account Already Exists</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="alert">
                <p style="margin: 0; color: inherit;">
                    <strong>Notice:</strong> We received a request to create a new PKey account using this email address. However, our records show that you are <strong>already registered</strong> with us.
                </p>
            </div>
            
            <p>There's no need to sign up again! You can simply log in to your existing account to access your vault securely.</p>
            ...
            <p style="margin-top: 25px; color: #718096;">If you didn't attempt to sign up recently, you can safely ignore this email. Your existing account remains completely secure.</p>
        </div>
...
export const accountTemporarilyLockedHtml = (name) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Your PKey Account is Temporarily Locked</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="security-alert">
                <p style="margin: 0; color: inherit;">
                    <strong>Security Alert:</strong> Your PKey account has been <strong>temporarily locked</strong> due to multiple failed login attempts. This is an automated security measure to protect your account from unauthorized access.
                </p>
            </div>
            
            <p>For your security, you will need to wait before trying again. You can attempt to log in again after <strong>30 minutes</strong>.</p>
            ...
            <p style="margin-top: 25px; color: #718096;">If you did not attempt to log in recently, we highly recommend checking your account security or contacting our support team.</p>
        </div>
