...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>&copy; ${new Date().getFullYear()} PKey. All rights reserved.</p>
            <p>Built for privacy, powered by trust.</p>
            <p><a href="${process.env.NEXT_PUBLIC_BASE_URL}/privacy-policy">Privacy Policy</a> | <a href="${process.env.NEXT_PUBLIC_BASE_URL}/terms-and-conditions">Terms & Conditions</a></p>
        </div>
    </div>
</body>
</html>`
