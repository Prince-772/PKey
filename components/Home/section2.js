...
const features = [
  {
    ...
    desc: "Your master password never reaches our servers. Encryption and decryption happen only on your device.",
    color: "blue",
    size: "large",
  },
  {
    icon: <Cpu className="h-6 w-6" />,
    title: "PBKDF2 Hardening",
    desc: "We use thousands of hashing iterations to protect your password from brute-force attacks.",
    color: "orange",
    size: "small",
  },
  {
    ...
    desc: "A military-grade standard used by the world's largest banks and security agencies.",
    color: "emerald",
    size: "small",
  },
  {
  ...
  },
  {
    ...
    desc: "See how strong your password is in real time - and how long it would take for a hacker to crack it.",
    color: "cyan",
    size: "large",
  },
  {
    ...
    desc: "No server delays. Encryption is instant since it runs on your browser engine.",
    color: "yellow",
    size: "small",
  },
  {
    icon: <Fingerprint className="h-6 w-6" />,
    title: "Unique Salting",
    desc: "Every user has a unique encryption path thanks to cryptographic salts.",
    color: "rose",
    size: "small",
  },
  {
    ...
    desc: "Your data is accessible worldwide, but only in encrypted (unreadable) form.",
    color: "indigo",
    size: "small",
  },
];
